...
<body>
    ...
    <div class="mainBody">
        <div id="topTitle">
			...
			<h3>Non sei ancora un utente? <a href="registrazione.php">Registrati</a> subito!</h3>
        </div>
        <div class="paragraph">
			<form name="form_login" method="post" action="loginavvenuto.php">
			<p>Username: <input type="text" name="username_login"></p>
			<br/>
			<p>Password:  <input type="password" name="password_login"></p>
			<br/>
